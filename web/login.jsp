...
<s:form name="loginForm" namespace="/" action="user_login" method="post" cssStyle="margin-top:250px;">
    <DIV align=center>
                    ...
                    <TABLE cellSpacing=0 cellPadding=0 width=623 align=center
                            ...
                            <TD align="right" background="" height=13>
                                <DIV align=left>
                                    <FONT color=#006633 size=2>用户名：</FONT><FONT color=#006633
                                                                                size=2><s:textfield cssClass="tx"
                                                                                                    maxLength="15"
                                                                                                    size="15"
                                                                                                    name="name"/>
                        ...
                        <TR>
                            <TD Align=left background="" height=9>
                                <DIV align=left>
                                    <FONT color=#006633 size=2>密码：<s:password cssClass="tx"
